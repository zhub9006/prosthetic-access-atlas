...
- **Total Records**: 644 studies indexed
- **Data Fields**: nctId, title, status, phase, sponsor, location, intervention, conditions, outcomes, eligibility

### Limitations
1. API timeout issues on large queries
2. Terminology variance may undercount
3. "UNKNOWN" status may not reflect actual abandonment
...
3. Cross-reference with route directions to nearest hub city
...
| Hub (WV) | Charleston | 38.35 | -81.63 | N/A |
| Hub (KY) | Charleston, WV | 38.35 | -81.63 | N/A |
